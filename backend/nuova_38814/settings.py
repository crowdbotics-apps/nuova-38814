"""
Django settings for nuova_38814 project.
...
WSGI_APPLICATION = 'nuova_38814.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "nuova_38814 API",
    "DESCRIPTION": "API documentation for nuova_38814 App",
    "VERSION": "v1",
}
